...
INSTALLED_APPS = (
    ...
    'gestion_usuario',
    'gestion_entrenador.gestion_liga',
    'gestion_entrenador.gestion_jornada',
    'gestion_entrenador.gestion_equipo',
    'gestion_entrenador.gestion_partido',
    'gestion_entrenador.gestion_clasificacion',
    'gestion_entrenador.gestion_jugador',
)
